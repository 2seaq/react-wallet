	...
	render() {
		...
		return (
			...
			>
				...
				>
					<ErrorIcon sx={{ mb: 2, fontSize: 100, color: '#2D9CDB' }} />
					<Typography >The transaction could not be completed.</Typography>
				</Box>
				...
				>
					...
					<Divider sx={{ borderColor: '#eee' }} />
					<Typography variant="body2" color="text.secondary">Error Details</Typography>
